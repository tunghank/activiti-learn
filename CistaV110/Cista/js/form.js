...
//By Substring
function SelectItem_Combo(objList, szItem)
{
	var nIndex;
	...
	{
		//alert( objList.options[i].text.substring(0,szItem.length) );
		if (objList.options[i].text.substring(0,szItem.length) == szItem) {
			nIndex = i;
		}
	}
