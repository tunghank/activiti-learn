package com.cista.system.ajax.action;
...
public class SmartSearchLoader {
    ...
    private Map<String, SmartSearchTo> smartsearches;
     ...
     * @return LovDefine
     */
    public static synchronized SmartSearchTo getSmartSearch(final String name) {
         //if (_instance == null) {
    ...
    public void addSmartSearch(final SmartSearchTo ld) {
        if (smartsearches == null) {
            smartsearches = new Hashtable<String, SmartSearchTo>();
        }
    ...
    private static SmartSearchLoader buildSmartSearch() {
        ...
        try {
            ...
            digester.addObjectCreate("SmartSearches/SmartSearch", SmartSearchTo.class);
