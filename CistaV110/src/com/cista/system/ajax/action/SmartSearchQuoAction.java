...
import com.cista.system.ajax.dao.SmartSearchQuoDao;
import com.cista.system.ajax.to.SmartSearchTo;
import com.cista.system.util.BaseAction;

public class SmartSearchQuoAction extends BaseAction {
	
	String columns;
	String like;
	
    public String smartSearchQuo() throws Exception {
        ...
        try {
        	...
        	if( inputFieldValue.equals("")){
        		...
        		List<Map<String, Object>> result = new SmartSearchQuoDao().find(ss, inputFieldValue);
