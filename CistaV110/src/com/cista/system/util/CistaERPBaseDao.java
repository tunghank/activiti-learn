 ...
 */
public class CistaERPBaseDao extends JdbcDaoSupport implements Serializable {
	 ...
	 * 
	 */
	public CistaERPBaseDao() {
		super();
        this.setDataSource(CistaUtil.getCistaERPDataSource());
        this.setTransactionTemplate(CistaUtil.getCistaERPTransactionTemplate());
