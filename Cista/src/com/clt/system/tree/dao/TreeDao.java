package com.clt.system.tree.dao;
...
import com.clt.system.to.MenuTo;
/**
 * @author 900730
 *
 */
public class TreeDao extends BaseDao {
	 ...
	 */
	public List<MenuTo> getSubTreeList(String parentId)
	 ...
	 */
	public List<MenuTo> getSubTreeListNotRoot(String parentId)
			throws DataAccessException {
		// TODO Auto-generated method stub
	...
	public List<MenuTo> getSubTreeListNotRootByUser(String parentId, String curUser)
			throws DataAccessException {
		// TODO Auto-generated method stub
		SimpleJdbcTemplate sjt = getSimpleJdbcTemplate();
