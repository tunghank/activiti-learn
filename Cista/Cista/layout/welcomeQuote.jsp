...
<body>
  ...
  <div id="center">
  	<iframe width="100%" height="100%" name="mainFrame" frameborder="0"  src='/quotation/quote/QuoPaperQuotePre.action?quoteHeaderUid=<%=quoteHeaderUid%>' scrolling="auto" noresize>
