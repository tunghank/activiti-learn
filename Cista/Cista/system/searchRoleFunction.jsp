...
<html>
<HEAD>
		<TITLE>System Assign Function Role Function</TITLE>
		...
		function searchRoleFunction(){
			...
			forma.action = "SearchRoleFunction.action";
			forma.method = "post";
			forma.target = "result";
			forma.submit();
		}
...
<BODY bgColor=#ffffff leftMargin=0 topMargin=0 onload = "firstRun();">
	...
	<tr>
		...
		<div align="left">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="Himax-OrangeLine">
				<tr>
					<td width="361" class="Himax-Title">System Assign Function Role Function</td>
				</tr>
			</table>
		</div>
		</td>
...
<%
							if (data != null && data.size() >0){
								for (SysRoleTo role : data){
									...
									String roleId = (String.valueOf(role.getRoleId()) != null? String.valueOf(role.getRoleId()) :"");
%>
						...
						<td class= "portlet-title-bgSearch2">
							<select name="leaf" id = "leaf" class = "Himax-asl-col-smaill">
