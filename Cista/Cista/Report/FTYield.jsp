	...
	*/
	...
	function submit(){//提交表單
		...
		Ext.Ajax.request({  //ajax request test  
				url : '<%=contextPath%>/FTYieldReport.action',  
				params : {
	...
	Ext.define(  
			...
			{  
				...
				fields:[  
						...
						{name:'strFtYield',mapping:'strFtYield'}
				]  
			}  
	)
	...
	<tr>
		...
		<div align="left">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="OrangeLine">
				<tr>
					<td class="Title">FT Yield  Report</td>
				</tr>
			</table>
		</div>
		</td>
