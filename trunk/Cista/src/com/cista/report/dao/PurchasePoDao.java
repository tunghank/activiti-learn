...
public class PurchasePoDao extends CistaERPBaseDao{
	...
	public List<PurchasePoTo> getOpenPO3301ByProduct(String product) throws DataAccessException{
		
		SimpleJdbcTemplate sjt = getSimpleJdbcTemplate();
		String sql  = " SELECT TC004 VENDOR ,PURMA.MA002 VENDOR_NAME, " +
					" TC001 + '-' + TC002 AS PO_NUM , " +
					" SUBSTRING(TD006,2,3) PRODUCT, " +
					...
					" Where (  TC014='Y') " +
					" AND TC001 = '3301' " +
					" AND SUBSTRING(TD006,2,3) ='" + product + "' " +
					" Group By TC004, PURMA.MA002, TC001 + '-' + TC002, " +
					" TD009, TD010, SUBSTRING(TD006,2,3) " +
					" Having (SUM(PURTD.TD008)- SUM(PURTD.TD015)) >= 0 " +
					" ORDER BY 1,2,3,4";
